...
export const usersCollection = dbUsers.collection<UserAccountDBType>('users'); // don't use anymore
export const usersAccountsCollection = dbAccounts.collection<UserAccountDBType>('accounts');
export const collections = [blogsCollection, videosCollection, postsCollection, commentCollection, usersAccountsCollection];
